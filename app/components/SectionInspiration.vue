<template>
  ...
  >
    <div class="mx-auto grid max-w-[1600px] grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-12">
      <div class="relative z-10 flex justify-center lg:col-span-6 lg:justify-start">
        <div class="relative aspect-square w-[105%] max-w-[400px] flex-shrink-0 sm:w-full md:w-[110%] md:max-w-[600px] lg:-ml-8 lg:w-[125%] lg:max-w-[750px] xl:-ml-16 xl:w-[135%] xl:max-w-[900px]">
          <div
            ref="recordDiscRef"
      ...
      <div class="relative z-0 flex w-full flex-col lg:col-span-6 lg:ml-auto lg:w-[calc(100%-3.125rem)] lg:pl-8 xl:pl-12">
        <div class="group relative border-b border-[#1D1E18]/10 py-[1.875rem] md:py-[2.875rem]">
          <div class="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden select-none">
            <span class="watermark-outline translate-x-2 font-serif text-[6rem] font-semibold leading-none tracking-[0.08em] md:text-[8.5rem] lg:text-[10.25rem]">
              MUSIC
            </span>
          </div>
          ...
          <div class="relative z-10 flex flex-col gap-6 md:flex-row md:gap-12">
            <div class="flex flex-col justify-center md:min-h-[100px] md:w-5/12 md:pt-10">
              <div
                ref="musicTitleViewportRef"
                class="music-title-marquee mb-2"
              >
                <div
                  class="music-title-track"
                  :class="{ 'music-title-track--scroll': isMusicTitleOverflowing }"
            ...
            <div class="grid grid-cols-2 gap-x-4 gap-y-6 md:w-7/12">
              <div class="col-span-2 flex justify-end font-mono text-[9px] tracking-widest text-[#1D1E18]/60">
                <span>{{ recentTrackPlayedAt }}</span>
              </div>

              <div class="col-span-2 mt-1 flex items-center justify-end gap-4 pr-3 md:pr-4">
                <div class="min-w-0 max-w-[11rem] text-right md:max-w-[13rem] lg:max-w-[15rem]">
                  <span class="block truncate font-mono text-[10px] tracking-[0.18em] text-[#1D1E18]/65">
                    {{ recentTrackAlbumText }}
                  </span>
                </div>
                <span class="shrink-0 font-mono text-[11px] font-bold text-[#1D1E18]/72">
                  ●
                </span>
                <div class="h-[100px] w-[100px] shrink-0 overflow-hidden rounded-[1.25rem] border border-[#1D1E18]/10 bg-[#ECE5D8]">
                  <img
                    :src="recentTrackCover"
                    :alt="`${recentTrackTitle} cover art`"
                    class="block h-full w-full object-cover"
        ...
        <div class="group relative border-b border-[#1D1E18]/10 py-[1.875rem] md:py-[2.875rem]">
          <div class="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden select-none">
            <span class="watermark-outline translate-x-4 font-serif text-[6rem] font-semibold leading-none tracking-[0.22em] md:text-[9rem] lg:text-[11rem]">
              BOOK
            </span>
          </div>
          ...
          <div class="relative z-10 flex flex-col gap-6 md:flex-row md:gap-12">
            <div class="flex flex-col justify-center md:w-5/12">
              <h3 class="font-serif text-3xl font-bold tracking-wide text-[#111] md:text-4xl">
                穷查理宝典
              </h3>
            </div>
            ...
            <div class="grid grid-cols-2 gap-x-4 gap-y-6 md:w-7/12">
              ...
              <div class="col-span-2">
                <h4 class="mb-1 text-xs font-bold tracking-widest text-[#1D1E18]/90">
                  核心洞察
                </h4>
                <p class="font-serif text-[13px] italic leading-relaxed text-[#1D1E18]/80">
              ...
              <div class="col-span-2 mt-2">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="h-[4px] w-24 overflow-hidden rounded-full bg-[#1D1E18]/20 md:w-32">
                    <div class="h-full rounded-full bg-[#1D1E18]/60" :style="{ width: `${bookProgress}%` }"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="group relative py-[1.875rem] md:py-[2.875rem]">
          ...
          <div class="relative z-10 flex flex-col gap-6 md:flex-row md:gap-12">
            <div class="flex flex-col justify-center md:w-5/12">
              <h3 class="font-serif text-lg font-medium tracking-[0.04em] text-[#1D1E18]/72 md:text-xl">
                最近看过的电影
              </h3>
              <p class="mt-2 text-[17px] font-semibold text-[#111] md:text-[18px]">
                片名：幽灵公主
              </p>
            </div>

            <div class="flex flex-col justify-end gap-3 pb-2 md:w-7/12">
              <div class="flex w-max items-center gap-3 border-b border-[#1D1E18]/20 pb-2 pr-6">
...
const stepRecordSpin = (timestamp: number) => {
  ...
  recordSpinRotation = (recordSpinRotation + recordSpinVelocity * deltaSeconds) % 360
