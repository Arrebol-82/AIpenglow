<template>
  <div class="mx-auto flex w-full max-w-[520px] flex-col gap-8">
    ...
    >
      ...
      <p class="text-[13px] md:text-sm font-medium leading-relaxed text-[#1D1E18]/90">
...
import WorksStamp from "~/components/Works/WorksStamp.vue";

const techStack = ["JavaScript", "HTML5", "CSS3", "React", "Tailwind CSS"];
</script>
