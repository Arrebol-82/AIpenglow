...
<template>
  <footer
    class="relative min-h-screen bg-[#f7f1e7] text-[#1D1E18] overflow-hidden flex flex-col justify-between px-[0.75rem] pt-8 pb-[0.125rem] md:px-[1.75rem] md:pt-12 md:pb-[1.125rem] lg:px-[3.75rem] lg:pt-16 lg:pb-[2.125rem]"
  >
    <div
      class="absolute inset-0 z-0 flex items-start justify-center overflow-hidden pointer-events-none select-none pt-[2vh] md:pt-[1vh]"
    >
      <h1
        class="font-serif text-[18vw] md:text-[23vw] font-bold leading-none opacity-[0.04] text-[#1D1E18] tracking-tight whitespace-nowrap"
      >
        AIpenglow
      </h1>
    </div>
    ...
    <div
      class="relative z-10 flex-1 flex items-center justify-center mt-12 translate-y-[10rem] md:mt-0 md:translate-y-[11rem]"
    >
      <p
        class="font-serif max-w-[46ch] text-center text-[1rem] md:text-[1.125rem] leading-[1.6] md:leading-[1.65] text-[#1D1E18]/90"
      >
    ...
    <div
      class="relative z-10 flex justify-between items-end w-full mt-24 md:mt-0"
    >
      ...
      <div
        class="flex flex-col items-end gap-6 translate-x-[1.25rem] md:translate-x-[1.5rem]"
      >
        ...
        <div
          class="pr-1 font-mono font-bold text-[10px] md:text-xs tracking-[0.15em] text-[#1D1E18]/80 uppercase"
        >
          {{ currentTimeLabel }}
        </div>
      </div>
